...
///   Example: `key1`, `x.y.z1`
public final class BrokerConnectRuntimeConfig {
    ...
    private BrokerConnectRuntimeConfig(
    ...
    public static class BrokerConnectConfigBuilder {
        ...
        public BrokerConnectRuntimeConfig build() {
            return new BrokerConnectRuntimeConfig(
                    properties,
                    dmsFactory,
                    jsonMapper,
                    pdfReader,
