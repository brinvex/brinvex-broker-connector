...
public class TestContext {
    ...
    private static class Lazy {
        ...
        private static Map<String, String> subProperties(String keyPrefix) {
            if (allTestProperties == null) {
                allTestProperties = loadProperties(HOME.resolve("brinvex-broker-connector-test.properties"), "test.");
            }
    ...
    public TestContext(Class<? extends Module> moduleType) {
        ...
        this.brokerConnector = BrokerConnector.newBrokerConnector(BrokerConnectorConfig.builder()
                .setProperties(this.properties
                        .entrySet()
                        .stream()
                        .filter(e -> e.getKey().startsWith(BrokerConnectorConfig.FULL_PROP_KEY_PREFIX))
    ...
    private TestContext(TestContext sourceCtx, Map<String, String> properties) {
        ...
        if (properties != null) {
            for (Map.Entry<String, String> e : properties.entrySet()) {
                ...
                this.properties.put(BrokerConnectorConfig.FULL_PROP_KEY_FORMATTER.apply(moduleType, key), value);
            }
        }
        this.brokerConnector = BrokerConnector.newBrokerConnector(BrokerConnectorConfig.builder()
                .setProperties(this.properties
    ...
    public BrokerConnector runtime() {
    ...
    public String dmsWorkspace() {
        return properties.get(BrokerConnectorConfig.FULL_PROP_KEY_FORMATTER.apply(moduleType, Module.PropKey.dmsWorkspace));
    }

    public <MODULE extends Module> MODULE get(Class<MODULE> moduleType) {
        return brokerConnector.getModule(moduleType);
    }
