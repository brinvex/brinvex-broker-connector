...
import com.brinvex.brokercon.core.api.BrokerConnectRuntimeConfig;
...
public class TestContext {
    ...
    private static class Lazy {
        ...
        private static final Path HOME = Optional.of("c:/prj/bx/bx-brokercon")
                .map(Paths::get)
                .orElseThrow();
        ...
        private static Map<String, String> subProperties(String keyPrefix) {
            if (allTestProperties == null) {
                allTestProperties = loadProperties(HOME.resolve("brinvex-brokercon-test.properties"), "test.");
            }
    ...
    private final BrokerConnectRuntime brokerConnectRuntime;
    ...
    public TestContext(Class<? extends Module> moduleType) {
        ...
        this.brokerConnectRuntime = BrokerConnectRuntime.newPtfActivityRuntime(BrokerConnectRuntimeConfig.builder()
                .setProperties(this.properties
                        .entrySet()
                        .stream()
                        .filter(e -> e.getKey().startsWith(BrokerConnectRuntimeConfig.FULL_PROP_KEY_PREFIX))
    ...
    private TestContext(TestContext sourceCtx, Map<String, String> properties) {
        ...
        if (properties != null) {
            for (Map.Entry<String, String> e : properties.entrySet()) {
                ...
                this.properties.put(BrokerConnectRuntimeConfig.FULL_PROP_KEY_FORMATTER.apply(moduleType, key), value);
            }
        }
        this.brokerConnectRuntime = BrokerConnectRuntime.newPtfActivityRuntime(BrokerConnectRuntimeConfig.builder()
                .setProperties(this.properties
    ...
    public BrokerConnectRuntime runtime() {
        return brokerConnectRuntime;
    }
    ...
    public String dmsWorkspace() {
        return properties.get(BrokerConnectRuntimeConfig.FULL_PROP_KEY_FORMATTER.apply(moduleType, Module.PropKey.dmsWorkspace));
    }

    public <MODULE extends Module> MODULE get(Class<MODULE> moduleType) {
        return brokerConnectRuntime.getModule(moduleType);
    }
